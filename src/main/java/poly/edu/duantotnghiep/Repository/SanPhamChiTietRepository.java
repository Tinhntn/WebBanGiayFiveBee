...
public interface SanPhamChiTietRepository extends JpaRepository<ChiTietSanPham, UUID> {
    ...
    @Query(value = "select chitietsanpham.id,sanpham.tensanpham as tensanpham, hang.tenhang as tenhang , size.ten as tensize, danhmuc.ten as tendanhmuc,chatlieu.ten as tenchatlieu,  mausac.ten as tenmausac,KhuyenMai.tenkhuyenmai as tenkhuyenmai,\n" +
            ...
            "join khuyenmai on khuyenmai.id = chitietsanpham.idkhuyenmai",nativeQuery = true)
